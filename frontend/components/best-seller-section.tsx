...
export default function BestSellerSection() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("/api/admin/products?category=bestsellers")
        if (res.ok) {
    ...
    <section className="py-16 md:py-24 px-6 md:px-12 bg-amber-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif text-amber-900 mb-4">Our Best Sellers</h2>
          <p className="text-amber-700 text-lg max-w-2xl mx-auto">
            Discover the most loved and cherished sweets from our collection
          </p>
